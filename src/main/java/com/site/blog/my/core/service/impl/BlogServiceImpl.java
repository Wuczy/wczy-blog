...
import com.site.blog.my.core.pojo.BlogCategory;
...
public class BlogServiceImpl implements BlogService {
    ...
    public String updateBlog(Blog blog) {
        ...
        blogForUpdate.setCreateTime(blog.getCreateTime());
        blogForUpdate.setUpdateTime(blog.getUpdateTime());
        BlogCategory blogCategory = categoryMapper.selectByPrimaryKey(blog.getBlogCategoryId());
        if (blogCategory == null) {
    ...
    @Override
    public int updateBlogStatus(Long id, byte status) {
        return blogMapper.updateBlogStatus(id,status);
    }
